"""Brick bar static analysis — CuPy ``gmres`` (GPU iterative)."""

import os
import sys

print("==========================")
print("Start cupy.gmres Example")
...
try:
    from openseespy_solvers.cupy import gmres
...
solver = gmres(rtol=1e-7, atol=1e-12)
